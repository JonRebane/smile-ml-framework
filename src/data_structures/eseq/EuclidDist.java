...
public class EuclidDist {
	...
	*/
	 ...
	 */
	public static int optimizedAbide(List<DefaultHashMap<String,Short>> target, List<DefaultHashMap<String,Short>> query, String [] queryAlphabet, String [] queryAlphabetDensityOrder)
	{
		long totalWindows = 0;
		List<DefaultHashMap<String,Short>> currentWindow = new ArrayList<DefaultHashMap<String,Short>>();
		for(int i=0; i < query.size(); i++)
