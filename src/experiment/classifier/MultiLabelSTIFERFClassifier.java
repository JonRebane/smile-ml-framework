...
public class MultiLabelSTIFERFClassifier extends AbstractSTIFERFClassifier {
	...
	public MultiLabelSTIFERFClassifier(List<Sequence> train, List<List<Integer>> classIds, int numDimensions,int sequenceDuration, int epsilon, int shapeletFeatureCount, ExecutorService pool) throws Exception {
		super(modifyTrainSet(train,classIds), modifyClassIds(classIds), numDimensions, sequenceDuration, epsilon, shapeletFeatureCount, pool);
